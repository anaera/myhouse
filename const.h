...
#define FLAG_CNT_BIT        65   //Флаги управления устройством
...
#define LOCK_TIME_SET       10  //время блокировки включения лампы по датчику
#define WAIT_TIME_SET       240 //время свечения лампы после активации по датчику 
